...
LABEL_ARG(text)
CALL_FUNCTION_NO_RET(BulletText, text)
END_IMGUI_FUNC


IMGUI_FUNCTION(Text)
LABEL_ARG(text)
CALL_FUNCTION_NO_RET(Text, text)
END_IMGUI_FUNC
...
LABEL_ARG(label)
LABEL_ARG(previewValue)
CALL_FUNCTION(BeginCombo, bool, label, previewValue)
PUSH_BOOL(ret)
END_IMGUI_FUNC
...
CALL_FUNCTION(BeginDragDropSource,bool)
PUSH_BOOL(ret)
END_IMGUI_FUNC
...
MAKE_ENUM(ImGuiHoveredFlags_None,Default)
